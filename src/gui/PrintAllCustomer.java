...
public class PrintAllCustomer extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		List<Customer> customers = CustomerSql.selectAllcustomer();
		...
		if (!customers.isEmpty()) {
			...
			setVisible(true);
			setTitle("All customers in our system");
			setSize(new Dimension(1044, 768));
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			add(scrollPane);
		} else {
			JOptionPane.showMessageDialog(null, "There is no customer in our system", "Error",
